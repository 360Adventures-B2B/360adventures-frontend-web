...
import ModalExportBooking from "./ModalExportBooking";
...
export default function BookingPage() {
  ...
  const bookingStatus =
    selectedStatus.toLowerCase() === "all" ? "" : selectedStatus.toLowerCase();
  ...
  return (
    <div className="relative">
        ...
        <NcModal
          ...
          renderContent={(closeModal) => (
            <ModalExportBooking
              ...
              initialFilters={{ fromDate, toDate, bookingStatus }}
              onExport={async ({ fromDate, toDate, bookingStatus }) => {
                try {
      ...
      <Tab.Group selectedIndex={selectedIndex} onChange={setSelectedIndex}>
        <Tab.List className="flex space-x-1 overflow-x-auto w-full pr-40">
          {" "}
          {/* kasih padding kanan biar ga nabrak filter */}
          {options.map((item) => (
                ...
                <>
                  ...
                  {bookings?.pagination?.last_page > 1 && (
                    <div className="text-center pt-5">
                      <Pagination
                        totalPages={bookings?.pagination?.last_page || 1}
